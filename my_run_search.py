...
SEARCHES = [["1: breadth_first_search", breadth_first_search, ""],
            ...
            ['4: depth_limited_search', depth_limited_search, ""],
            ['5: uniform_cost_search', uniform_cost_search, ""],
            ['6: recursive_best_first_search', recursive_best_first_search, 'h_1'],
            ['7: greedy_best_first_graph_search', greedy_best_first_graph_search, 'h_1'],
            ['8: astar_search', astar_search, 'h_1'],
            ['9: astar_search', astar_search, 'h_ignore_preconditions'],
            ['10: astar_search', astar_search, 'h_pg_levelsum'],
            ]
